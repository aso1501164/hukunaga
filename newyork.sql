...
--
-- Host: 127.0.0.1
-- Generation Time: 2017 年 6 朁E27 日 08:05
...
INSERT INTO `application` (`student_id`, `subject_id_1`, `subject_id_2`, `year`, `subject_name`) VALUES
('0001', '2001', '2002', 'H30', 'プロジェクト開発演習'),
('0002', '2002', '2003', 'T10', 'イシュカン・コミュニケーション');
...
INSERT INTO `history` (`student_id`, `subject_id_1`, `subject_id_2`, `year`, `subject_name`) VALUES
('0001', '2001', '2002', 'H30', 'プロジェクト開発演習'),
('0001', '2002', '2002', 'T10', 'イシュカン・コミュニケーション'),
('0002', '2003', '2002', 'T10', '英会話');
...
ALTER TABLE `application`
  ...
  ADD CONSTRAINT `application_ibfk_4` FOREIGN KEY (`subject_name`) REFERENCES `subject` (`subject_name`);
...
ALTER TABLE `history`
  ...
  ADD CONSTRAINT `history_ibfk_5` FOREIGN KEY (`subject_name`) REFERENCES `subject` (`subject_name`);
