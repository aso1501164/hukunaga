...
--
-- Host: 127.0.0.1
-- Generation Time: 2017 年 6 朁E28 日 02:57
...
CREATE TABLE `application` (
  ...
  `subject_name_1` varchar(15) NOT NULL,
  `subject_name_2` varchar(15) NOT NULL
...
INSERT INTO `application` (`student_id`, `subject_id_1`, `subject_id_2`, `year`, `subject_name_1`, `subject_name_2`) VALUES
('0001', '2001', '2002', 'H30', 'プロジェクト開発演習', 'イシュカン・コミュニケーション'),
('0002', '2002', '2003', 'T10', 'イシュカン・コミュニケーション', '英会話');
...
INSERT INTO `history` (`student_id`, `subject_id_1`, `subject_id_2`, `year`, `subject_name_1`, `subject_name_2`) VALUES
('0001', '2001', '2002', 'H30', 'プロジェクト開発演習', 'イシュカン・コミュニケーション'),
('0001', '2002', '2002', 'T10', 'イシュカン・コミュニケーション', 'イシュカン・コミュニケーション'),
('0002', '2003', '2002', 'T10', '英会話', 'イシュカン・コミュニケーション');
...
ALTER TABLE `application`
  ...
  ADD KEY `year` (`year`),
  ADD KEY `subject_name` (`subject_name_1`),
  ADD KEY `subject_name_2` (`subject_name_2`);
...
ALTER TABLE `application`
  ...
  ADD CONSTRAINT `application_ibfk_4` FOREIGN KEY (`subject_name_1`) REFERENCES `subject` (`subject_name`),
  ADD CONSTRAINT `application_ibfk_5` FOREIGN KEY (`subject_name_2`) REFERENCES `subject` (`subject_name`);
...
ALTER TABLE `history`
  ...
  ADD CONSTRAINT `history_ibfk_5` FOREIGN KEY (`subject_name_1`) REFERENCES `subject` (`subject_name`),
  ADD CONSTRAINT `history_ibfk_6` FOREIGN KEY (`subject_name_2`) REFERENCES `subject` (`subject_name`);
