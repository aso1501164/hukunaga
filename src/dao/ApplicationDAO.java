...
public class ApplicationDAO {
	 ...
	 */
	public void UpdateApplication(String subject_id_1, String subject_id_2, String subject_name_1,
			String subject_name_2, String year, String student_id) {

		try {
			// DB接続
			connection();

			String sql = "UPDATE application SET subject_id_1 = ?, subject_id_2 = ? ,subject_name_1 = ?, subject_name_2 = ?, year = ? WHERE student_id = ? ;";

			stmt = con.prepareStatement(sql); // sql文をプリコンパイルした状態で保持

			stmt.setString(1, subject_id_1);
			stmt.setString(2, subject_id_2);
			stmt.setString(3, subject_name_1);
			stmt.setString(4, subject_name_2);
	 ...
	 */
	public void InsertApplication(String student_id,String subject_id_1, String subject_id_2,String year, String subject_name_1,
			String subject_name_2  ) {
		...
		try {
			...
			stmt.setString(5, subject_name_1);
			stmt.setString(6, subject_name_2);
